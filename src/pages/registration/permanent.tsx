    ...
    <Layout>
      <ContentWrapper>
        ...
        <Callout alternative>
          ...
          <p>Permanents are not sanctioned by ACP, and therefore do not take the place of brevets for the ACP Super Randonneur award, nor will they count for qualification for PBP. However they remain a great way to engage in the sport of randonneuring at the club level. 
          </p>
          <hr />
          ...
          <li>Once approved, changes to the request must be communicated with, and approved by, the route's regional Chapter VP. </li><ul>
          </p>
          ...
          <li>As with brevets, once the ride is completed, proof of passage must be sent to the route's regional chapter VP for club sanctioning. This is typically done in the form of control card photos (front and back), as well as a GPX file, or link to an online record of the travel log. </li></ul>
          </p>
          <p>
