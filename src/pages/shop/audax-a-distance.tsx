  ...
  return (
    <Layout>
      ...
      <ContentWrapper container>
        <ContentChild>
          <h1>Club Audax à Distance</h1>
          <h2>cycling patch</h2>
          <p>
            A custom patch to celebrate riding by your lonesome!{' '}
            <em>Club Audax à Distance</em> is a play on "long distance
            relationships" and the time we spend together. Get your own
            randonneuring cycling patch to put on bags, jerseys, tool pouches,
            or put in your map pouch!
          </p>
          ...
          <p>
            Made in Toronto by{' '}
            <Link href="http://www.sugarbomb.ca/">Sugarbomb</Link>, designed by{' '}
            <Link href="http://www.garethfowler.com/">Gareth Fowler</Link>.
          </p>
