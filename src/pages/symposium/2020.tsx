  ...
  return (
    <Layout>
      ...
      <ContentWrapper container>
        <ContentChild>
          <p>
            Randonneurs Ontario (Canada) usually has a new members night every
            year for folks to ask questions about randonneuring. Since we've
            gone fully virtual this year, you don't have to be in Ontario to
            join!
          </p>

          <p>
            Join Randonneurs Ontario (Canada) on 17 February 2021 at 7:00pm EST
            (4:00pm PST) on Zoom for the first ever RO Virtual Symposium! A
            perfect way to get better acquainted with randonneuring and to help
            you pull through the winter to get to the season start.
          </p>
