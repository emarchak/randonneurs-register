  ...
  return (
    <Layout>
      ...
      <ContentWrapper container>
        <ContentChild>
          <p>
            Randonneurs Ontario is a long-distance cycling club that has been
            riding out of Toronto, Canada since 1983. We normally do an
            in-person New Members night for folks to ask questions about
            randonneuring. Since we had such great success from doing an online
            symposium last year, we're doing it again. You don't have to be in
            Ontario to join!
          </p>

          <p>
            Join Randonneurs Ontario on 16 February 2022 at 7:00pm EST (4:00pm
            PST) on Zoom for our second Virtual Symposium! A perfect way to get
            better acquainted with randonneuring and to help you pull through
            the winter to get to the season start.
          </p>
          ...
          <ul>
            ...
            <li>
              Categories of rides: Populaires, Permanents, Brevets, Super
              Randonneur
            </li>
