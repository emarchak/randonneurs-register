...
describe('<RegistrationForm>', () => {
      ...
      brevets: [
        {
          ...
          distance: 60,
          date: new Date('Sat August 7 2021 09:15:00 EDT'),
  ...
  it('renders all the required fields to the user', () => {
    ...
    expect(mount.baseElement).toHaveTextContent(
      /Learn more about riding brevets/i
    )
        ...
        expect.objectContaining({
          ...
          body: JSON.stringify({
            ...
            row: {
              ...
              rideType: 'populaire',
              startTime: '09:15',
              scheduleTime: 'Sat August 7 2021 09:15',
              startLocation: 'Second Cup, 355 Danforth Ave, Toronto',
              chapter: 'Toronto',
              distance: 60,
              notes: 'notes',
