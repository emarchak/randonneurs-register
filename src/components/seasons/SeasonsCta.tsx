  ...
  <Callout alternative>
    <ContentWrapper>
      ...
      <p>
        ...
        , the parent organization governing the qualification of riders wishing
        to participate in the 1200K Paris - Brest - Paris Randonnee. The club is
      ...
      <p>
        <LinkButton to="/registration/" secondary block>
